...
namespace AwesomeToon
{
    ...
    public class AwesomeToonHelper : MonoBehaviour
    {
        ...
        [SerializeField] bool instanceMaterials = true;
        ...
        void Init()
        {
            ...
            for (int i = 0; i < materials.Length; i++)
            {
                ...
                {
                    var materialInstance = new Material(mat);
                    materialInstance.name = "Instance of " + mat.name;
                    materialInstances[i] = materialInstance;
                }
                else
                {
                    materialInstances[i] = mat;
                }
            }
            ...
            if (skinRenderer) skinRenderer.materials = materialInstances;
            if (meshRenderer) meshRenderer.materials = materialInstances;
        }
